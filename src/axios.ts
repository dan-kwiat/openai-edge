...
export declare class AxiosHeaders {
  ...
  concat(
    ...targets: Array<AxiosHeaders | RawAxiosHeaders | string>
  ): AxiosHeaders
...
export interface AxiosDefaults<D = any>
  extends Omit<RawAxiosRequestConfig<D>, "headers"> {
...
export declare function formToJSON(
  form: GenericFormData | GenericHTMLFormElement
): object

export declare function isAxiosError<T = any, D = any>(
  payload: any
): payload is AxiosError<T, D>

export declare function spread<T, R>(
  callback: (...args: T[]) => R
): (array: T[]) => R
